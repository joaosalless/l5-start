...
return [
	...
	*/
	...
	'path_presenter'           => app_path('Presenters/'),

	'path_transformer'         => app_path('Transformers/'),
	...
	'path_views'               => base_path('resources/views/app/'),
	...
	*/
	...
	|--------------------------------------------------------------------------
	|
	| Interface extend Configuration.
	*/

	'base_repository_interface' => 'Prettus\Repository\Contracts\RepositoryInterface',
